...
router.post('/reset-password', async (req, res) => {
  try {
    ...
    console.log('Reset password attempt:', { email, hasToken: !!token, hasPassword: !!newPassword });
    ...
    console.log('Attempting password reset with token:', token, 'for email:', email);
...
router.post('/resend-forgot-password', async (req, res) => {
  try {
    ...
    res.status(200).json({
      success: true,
      message: 'If your email is registered, you will receive a new password reset link'
    });
