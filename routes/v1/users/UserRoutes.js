...
router.post("/signup", validators.signup, async (req, res) => {
  const { firstName, lastName, email, phone, password, location, dateOfBirth } =
    req.body;
...
// Update user profile
router.put("/profile", protect, validators.updateProfile, async (req, res) => {
  try {
    ...
    if (skills) {
      ...
      if (typeof skills === "object" && !Array.isArray(skills)) {
        ...
        console.log(
          "Structured skills to save:",
          JSON.stringify(updateData.skills, null, 2)
        );
        ...
        console.log(
          "Legacy skills converted to structured:",
          JSON.stringify(updateData.skills, null, 2)
        );
      }
    }
