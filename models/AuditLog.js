...
const auditLogSchema = new mongoose.Schema({
  action: {
    ...
    enum: [
      ...
      'profile_update', 'task_create', 'task_update', 'task_delete',
      'user_suspend', 'user_activate', 'user_delete', 'payment_process',
      'admin_access', 'settings_change', 'export_data', 'import_data',
      'bulk_action', 'system_config', 'security_event', 'error_event'
    ]
  },
  resource: {
    type: String,
    ...
    enum: [
      'user', 'task', 'payment', 'offer', 'review', 'message',
      'admin_setting', 'system_config', 'export', 'import',
      'notification', 'media', 'category', 'tag'
    ]
  },
  resourceId: {
    type: mongoose.Schema.Types.ObjectId,
    required: function() {
      return this.resource !== 'system_config' && this.resource !== 'export' && this.resource !== 'import' && this.action !== 'login';
    }
  },
  performedBy: {
    type: mongoose.Schema.Types.ObjectId,
  ...
  category: {
    ...
    enum: [
      ...
      'system_administration', 'security', 'user_management',
      'content_management', 'financial', 'communication', 'reporting'
    ],
    required: true
  }
}, {
